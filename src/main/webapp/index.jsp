...
<body>
	<h1 style="color: violet; font-size: 40px;" align="center">HEY WE DEPLOYED OUR APP USING PAVAN</h1>
	...
	<h2 style="color: black; font-size: 40px;" align="center">WE INTEGRATED NEXUS WITH PAVAN</h2>
